...
<html>
	<head>
		...
		<title>Login | Online Quizzo</title>
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
						<center> <h5 style="font-family: Noto Sans;">Login to </h5><h4 style="font-family: Noto Sans;">Online Quizzo</h4></center><br>
							<form method="post" action="login.php" enctype="multipart/form-data">
								...
								<div>
									<a href="admin.php" cless=""button button-primary" >Admin Pannel</a>
							</form>
						</div>
					</div>
				</div>
