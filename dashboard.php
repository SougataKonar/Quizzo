...
<head>
    ...
    <title>Dashboard | Online Quizzo</title>
    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>Online Quizzo</b></a>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==0)
                {
                   echo '<h1 style=  "font-family: Arial, Helvetica, sans-serif";> Welcome to admin Page 
					</h1>';
